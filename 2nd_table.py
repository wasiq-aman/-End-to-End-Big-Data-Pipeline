...
PG_TABLE = 'public.2nd_table'

# CONFIG - MINIO
MINIO_ENDPOINT = 'http://127.0.0.1:9000'
MINIO_ACCESS_KEY = 'minio'
MINIO_SECRET_KEY = 'minio123'
MINIO_BUCKET = '2nd_table'
...
TS_EXPECTED_COLUMNS = {
    ...
    'EVENT_DATE': 'date',   # intentionally capitalized dummy column
    'device_type': 'text',
...
def write_temp_parquet(df, target_date):
    ...
    temp_key = f"user_events/temp/{target_date}.parquet"
...
def save_to_monthly_parquet(df, target_date):
    ...
    key = f"user_events/{year}/{month_name}_raw.parquet"
